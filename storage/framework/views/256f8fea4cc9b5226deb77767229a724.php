<div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="featured-item">
                        <div class="featured-item-img">
                            <a href="#">
                                <img class="img" src="<?php echo e(Storage::url($product->foto)); ?>" alt="Images">
                            </a>
                        </div>
                        <div class="content">
                            <div class="content-in">
                                <h4>$<?php echo e($product->precio_compra); ?> </h4>
    ...
    <div class="col-md-5">
                ...
                <!--[if BLOCK]><![endif]--><?php if($cartItems->isNotEmpty()): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="align-middle"><span style="font-size: 9px;">$<?php echo e(number_format($item->price, 2)); ?></span></td>
        ...
        <div class="card-footer">
            <h3>Total del Carrito: $<?php echo e(Cart::subtotal()); ?></h3>
        </div>
    </div>

</div>
<?php /**PATH C:\laragon\www\sales\resources\views/livewire/product-compra.blade.php ENDPATH**/ ?>