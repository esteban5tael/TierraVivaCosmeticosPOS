                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="featured-item">
                        <div class="featured-item-img">
                            <a href="#">
                                <img class="img" src="<?php echo e(($product->foto) ? Storage::url($product->foto) : asset('img/default.png')); ?>" alt="Images">
                            </a>
                        </div>
                        <div class="content">
            ...
            <tbody>
                <!--[if BLOCK]><![endif]--><?php if($cartItems->isNotEmpty()): ?>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <p style="font-size: 9px;"><?php echo e($item->name); ?></p>
                            </td>
                            <td width="100">
                            ...
                            <td style="font-size: 9px;">$<?php echo e(number_format($item->price, 2)); ?></td>
                            <td><button wire:click="removeFromCart('<?php echo e($item->rowId); ?>')"
...
<?php /**PATH C:\laragon\www\sales\resources\views/livewire/product-cotizacion.blade.php ENDPATH**/ ?>