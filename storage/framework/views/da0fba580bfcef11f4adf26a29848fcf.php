    ...
    <div class="row">
        <div class="col-sm-12">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('categorias.create')): ?>
                <div class="mb-2">
                    <a href="<?php echo e(route('categorias.create')); ?>" class="btn btn-primary btn-sm" data-placement="left">
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        var editUrl = "<?php echo e(route('categorias.edit', ['categoria' => 0])); ?>";
        var deleteUrl = "<?php echo e(route('categorias.destroy', ['categoria' => 0])); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\TierraVivaCosmeticosPOS\resources\views/categoria/index.blade.php ENDPATH**/ ?>